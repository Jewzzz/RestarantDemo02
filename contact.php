      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
            ...
            <form action="php/insert_data_contact_form.php" method="POST" class="p-5 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" id="phone" name="contact" class="form-control" placeholder="Phone #">
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                <input type="reset" value="Reset" class="btn btn-primary pill px-4 py-2">
          ...
          <div class="col-lg-4">
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-4">Navinka Hotel. , Mathara road, Thangalle , Sri Lanka.</p>

              <p class="mb-0 font-weight-bold">Phone</p>
              <p class="mb-4"><a href="#">+94 70 4643 559</a></p>

              <p class="mb-0 font-weight-bold">Email Address</p>
              <p class="mb-0"><a href="#">jeewaka9611@gmail.com.com</a></p>
