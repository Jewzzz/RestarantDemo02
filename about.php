      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7 text-center" data-aos="fade">
            <span class="caption mb-3">Navinka Hotel &amp; Resort</span>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="section-heading text-left">
            ...
            <p class="mb-4">Everyday life is filled with opportunities to seek the exceptional, 
            encounter the new and widen our horizons. For our worldly guests, 
            ...
            <p><a href="video/tangalle documentery.mp4" class="popup-vimeo text-uppercase">Watch Video <span
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a href="#" class="d-block mb-4 thumbnail"><img src="images/person_8.jpg" alt="Image"
                  class="img-fluid"></a>
              <div class="p-4">
                <h3 class="heading mb-3"><a href="#">Mr.Jeewaka Gamage</a></h3>
                <p>Maroon Stalks, a French national, believed 
                he were safer in Sri Lanka and need not look over his shoulder here as opposed to when in his own country.
               </p>
                <p><a href="#" class="text-primary"><span class="icon-arrow-right small"></span></a></p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a href="#" class="d-block mb-4 thumbnail"><img src="images/person_6.jpg" alt="Image"
                  class="img-fluid"></a>
              <div class="p-4">
                <h3 class="heading mb-3"><a href="#">Maroon Stalks</a></h3>
                <p>Maroon Stalks, a French national, believed 
                he were safer in Sri Lanka and need not look over his shoulder here as opposed to when in his own country.</p>
                <p><a href="#" class="text-primary"><span class="icon-arrow-right small"></span></a></p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a href="#" class="d-block mb-4 thumbnail"><img src="images/person_7.jpg" alt="Image"
                  class="img-fluid"></a>
              <div class="p-4">
                <h3 class="heading mb-3"><a href="#">Megan Person</a></h3>
                <p>Maroon Stalks, a French national, believed 
                he were safer in Sri Lanka and need not look over his shoulder here as opposed to when in his own country.</p>
                <p><a href="#" class="text-primary"> <span class="icon-arrow-right small"></span></a></p>
              </div>
